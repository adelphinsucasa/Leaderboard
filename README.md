...
<div align="center">
  <img  src="./assets/images/JoseDelphin.jpg" alt="logo" width="140"  height="auto" />
  <br/>

  <h3><b>Jose Alejandro Delphin Puente</b></h3>
  <h3><b>Leaderboard by Jose Delphin</b></h3>
</div>
...
# 📖 Leaderboard By Jose Delphin <a name="about-project"></a>
...
```sh
  git clone https://github.com/adelphinsucasa/Leaderboard.git
```
...
This project is (<a href="https://github.com/adelphinsucasa/Leaderboard/blob/develop/LICENSE">MIT License</a>) licensed.
